...
{
    // wtxid commits to all witness data, asset commitment is checked against rangeproof witness
    uint256 entry;
    surjectionProofCache.ComputeEntry(entry, wtxid, std::vector<unsigned char>(std::begin(gen.data), std::end(gen.data)));
