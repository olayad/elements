...
# Start bitcoind, then elementsd. As long as bitcoind is in RPC warmup, elements will connect
...
# In regtest mining "target" is OP_TRUE since we have not set signblock argument
e1.generate(101)
sync_all(e1, e2)
...
# First, send OP_TRUE to two different wallets for more useful scenarios
...
# Funds should be evenly split between the two wallets
e1.getwalletinfo()
e2.getwalletinfo()
